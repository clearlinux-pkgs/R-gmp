...
Version  : 0.7.3
Release  : 70
URL      : https://cran.r-project.org/src/contrib/gmp_0.7-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gmp_0.7-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701293982
