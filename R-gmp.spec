...
Version  : 0.7.1
Release  : 64
URL      : https://cran.r-project.org/src/contrib/gmp_0.7-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gmp_0.7-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675886911
